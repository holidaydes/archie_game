...
public class ArchieControllerProcessor {
    ...
    private final int cleftCode;
    private final int crightCode;
    private final int cjumpCode;
    private final int crunCode;
    private final int cswordCode;
    private final int cshieldCode;
    private final int cpauseCode;
    private final int cexitCode;
